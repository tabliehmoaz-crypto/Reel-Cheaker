/*
  REEL CHECK — LOCAL ANALYSIS ENGINE
  ----------------------------------
  Local-first engine.
...
export async function analyzeReel(file, options = {}) {
  ...
  */
  ...
  /*
    ...
    لا ندعي أننا نستطيع قياس "قوة الفكرة"
    من البكسلات وحدها.

    إذا توفر الكلام، نستخدم إشاراته.
  */
...
function detectDropOffPoints(
  ...
  for (
    ...
    /*
      تغير منخفض جداً بعد بداية
      = منطقة تستحق المراجعة،
      وليس دليلاً على هروب فعلي.
    */
