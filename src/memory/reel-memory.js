...
/*
  ...
  كل Google Account له Memory مستقلة.
*/
...
function updateExperiment(
  ...
  /*
    لا يمكن لأي update تغيير
    ملكية الـ Experiment لحساب آخر.
  */
...
function normalizeExperiment(
  ...
  return {
    ...
    /*
      الحساب الحالي هو المصدر
      النهائي للـ ownership.
    */
...
function normalizeImportedExperiment(
  experiment
) {
  ...
  /*
    Old V3 data may not have accountId.
    Such data is accepted only inside
    the currently active storage bucket.
  */
